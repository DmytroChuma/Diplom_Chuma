    ...
    for (let i = 0 ; i < props.images.length; i++) {
        images.push(
            <div key={i} className={"small-photo " + (i === 0 ? "active" : "")} onClick={() => {clickHandler(i)}}>
                ...
                <img className="viewer-photo small" src={"http://localhost:3001/"+props.id+"/"+ props.images[i]} alt=''/>
            </div>
        );
        ...
        <div className="photo-viewer-container">
            <div className="navigate-container">
                ...
                <div className="viewer-main-photo">
                    <img className="viewer-photo" src={"http://localhost:3001/"+props.id+"/" + props.images[count]} alt='' />
                </div>
