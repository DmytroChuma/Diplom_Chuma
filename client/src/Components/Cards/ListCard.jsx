    ...
    render () {
        ...
        for (let i = 1; i < this.props.images.length && i < 4; i++) {
            ...
            images.push(<div key={i} className="small-image-box">
                <img className="small-image" alt="" src={"http://localhost:3001/"+this.props.id+"/"+this.props.images[i]}/>
            ...
            <div className="ListCard">
                <div className="list-images-container">
                    <div className="list-preview-container">
                        <img className="list-preview" src={"http://localhost:3001/"+this.props.id+"/"+this.props.images[0]} alt=""/>
                    </div>
                ...
                <div className="list-info-container">
                    ...
                    <div className="list-info">{this.props.square} м<sup>2</sup></div>
