...
export default function ListCard (props) {
    ...
    for (let i = 1; i < props.images.length && i < 4; i++) {
        images.push(<div key={i} className="small-image-box">
            <img className="small-image" alt="" src={"https://diplomchuma-production.up.railway.app/"+props.slug+"/"+props.images[i]}/>
            ...
            <div className="list-images-container">
                <div className="list-preview-container">
                    <Link to={'/advertisement/'+ props.slug}>
                        <img className="list-preview" src={"https://diplomchuma-production.up.railway.app/"+props.slug+"/"+props.images[0]} alt=""/>
                    </Link>
                </div>
