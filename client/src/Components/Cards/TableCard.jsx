        ...
        return (
            <div className="tableCard">
                <div className="table-card-image-container">
                    <img className="table-card-photo" src={"http://localhost:3001/"+ this.props.id +"/"+this.props.images[0]} alt=""/>
                ...
                <div className="table-card-info-container">
                    ...
                    <div className="table-info">{this.props.square} м<sup>2</sup></div>
