...
export default function Chat({socket}) {
  ...
  useEffect(()=>{
    ...
    const load = async() => {
      await fetch('https://diplomchuma-production.up.railway.app/new_chat').then((res)=>res.json()).then((inbox)=>{
        fetch('https://diplomchuma-production.up.railway.app/chat').then((res) => res.json()).then((data) => {
  ...
  useEffect(()=>{
    ...
    fetch('https://diplomchuma-production.up.railway.app/messages?inbox='+location.hash.replace('#', '')).then((res) => res.json()).then((data) => {
  ...
  useEffect(()=>{
    ...
    socket.on('receive_message', (data)=> {
      ...
      fetch('https://diplomchuma-production.up.railway.app/set_read_message', {
        method: 'POST',
        headers: {
