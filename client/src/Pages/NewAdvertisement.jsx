    ...
    const getData = (data) => {
      ...
      const handleSubmit = (e) => {
       ...
       /* console.log(number.value);
        ...
        console.log(advertisementType.value);
        ...
        console.log(house_type.value);
        console.log(dwelling_type.value);
        console.log(rooms_count);
        console.log(floor_count);
        console.log(mansard.value);
        console.log(basement.value);
        console.log(wall);
        console.log(heating.value);
        console.log(plan.value);
        console.log(furniture.value);
        console.log(general_square);
        console.log(living_square);
        console.log(area);
        console.log(unit);
        console.log(garage.value);
        console.log(fireplace.value);
        console.log(balcony.value);
      ...
      const handleWarning = (text) => {
        setWarning(<WarningDialog text={text} />);
            ...
            <div className="container">
                ...
                <form className="new" onSubmit={handleSubmit}>
                    ...
                    <div className="content-container">
                        ...
                        <MapElement center={[48.9, 30.0]} position={[50.44351305245807, 30.520019531250004]} handlePosition={setPosition}/>
                    </div>
