...
app.get('/editor/:slug', authentiphicateToken, advertisementController.loadAdvertisementForEditor)

app.post("/save_advertisement", advertisementController.createAdvertisement)

app.post('/update_advertisement', authentiphicateToken, advertisementController.updateAdvertisement)

app.post("/archive",authentiphicateToken, advertisementController.addToArchive)

app.post("/delete_post",authentiphicateToken, advertisementController.deletePost)
